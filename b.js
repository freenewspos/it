 ...
 * 
 * Update 2011-12 By freenewspos.com on Line 106, 107
 * show() -> addClass()
 * hide() -> removeClass()
 */
...
if(stopAuto){if(options.auto){base.stopShow(true);}}
if(!options.infiniteLoop){if(!isWorking){var slideLoop=false;currentSlide=currentSlide-options.moveSlideQty;if(currentSlide<0){currentSlide=0;if(options.hideControlOnEnd){$('.bx-prev',$outerWrapper).addClass('bx-hidden');}}
...
return false;});}
function checkEndControls(){if(!options.infiniteLoop&&options.hideControlOnEnd){if(currentSlide==firstSlide){$('.bx-prev',$outerWrapper).addClass('last-end');}else{$('.bx-prev',$outerWrapper).removeClass('last-end');}
if(currentSlide==lastSlide){$('.bx-next',$outerWrapper).addClass('next-end');}else{$('.bx-next',$outerWrapper).removeClass('next-end');}}}
